#!/usr/bin/env python3
"""
Content Planning Agency Simple Demo
Demonstrates the functionality without emojis for Windows compatibility
"""
...
def test_agency_components():
    ...
    print("✓ Business data collected successfully")
    ...
    print("✓ Brand personality assessed successfully")
    ...
    print("✓ Platforms selected successfully")
    ...
    print("✓ Strategy framework created successfully")
    ...
    sample_post = {
        ...
        "caption": "Did you know that small businesses using technology see 40% faster growth? Here are three key strategies...",
    ...
    print("✓ Visual concept generated successfully")
    ...
    print("✓ Hashtag strategy developed successfully")
    ...
    print("✓ Complete content plan assembled successfully")
    ...
    print("\nALL TESTS PASSED!")
    print("\nSummary:")
    print("  • Business data collected: ✓")
    print("  • Brand personality assessed: ✓")
    print("  • Platforms selected: ✓")
    print("  • Strategy framework created: ✓")
    print("  • Content calendar built: ✓")
    print("  • Visual concepts generated: ✓")
    print("  • Hashtag strategy developed: ✓")
    print("  • Complete plan assembled: ✓")
